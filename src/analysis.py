...
# Dictionary to store the count of classes taken with each person
classmate_counts = {}
...
print(f"The maximum number of classes you took with a single person is: {max_class_count}")
top_classmates = [name for name, count in sorted_class_counts if count == max_class_count]
print("Here are the people who have taken the most classes with you:")
